...
export function GITHUB_SINGLE_REPO(repoName: string): string {
  return `https://api.github.com/repos/${CONFIG.github.username}/${repoName}`;
}

export const GITHUB_README = `https://api.github.com/repos/${CONFIG.github.username}/${CONFIG.github.username}/readme`;

export const GITHUB_JSON =
  `https://api.github.com/repos/${CONFIG.github.username}/${CONFIG.github.username}/portfolio.json`;
